...
#define	BRAKES_LED_STATE_CNT_U8				        (uint8)10u			///< LED debounce counter
...
static uint8 g_Brakes_SW_u8 = 0u;	                                    ///< ADC SW analog
static float32 g_Brakes_Ultrasonic_Distance_cm_f32 = 0.0f;				///< Distance measured by the ultrasonic sensor [cm]
static uint16 g_Brakes_Ultrasonic_Distance_cm_u16 = 0;				    ///< Distance measured by the ultrasonic sensor [cm] integer value
